...
class UserDownloads(models.Model):
    ...
    download_avatar = models.FileField(upload_to=download_user_avatar, blank=True, null=True,
...
class Article(models.Model):
    # author = models.ForeignKey(get_user_model(), on_delete=models.CASCADE, verbose_name="author_article")
    author = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="author_article", blank=True, null=True,)
...
class Commentary(models.Model):
    article = models.ForeignKey(Article, on_delete=models.CASCADE, verbose_name="Article", blank=True, null=True,
                                related_name='comments_srticles')
    user = models.ForeignKey(get_user_model(), on_delete=models.CASCADE, verbose_name="author_comm")
